    ...
    <section style="display:flex; justify-content:center; align-items:center; padding:3rem; position:relative; min-height: calc(70vh - 70px);">
        ...
        <div style="width:400px; background:#fff; padding:2rem 2.5rem; border-radius:20px; box-shadow:0 0 15px rgba(0,0,0,0.05); z-index:2;">
          ...
          <form method="post" action="">
            ...
            <div style="margin-bottom:1rem;">
              <label style="font-weight:bold; display:block; margin-bottom:0.3rem;">Área</label>
              <div style="display:flex; align-items:center;">
                <span style="margin-right:8px;">📚</span>
                <input type="text" name="user_area" placeholder="Entra tu área" required style="flex:1; padding:10px; border-radius:10px; border:1px solid #ddd;">
              </div>
            </div>

            <div style="margin-bottom:1rem;">
                <label style="font-weight:bold; display:block; margin-bottom:0.3rem;">Colegio</label>
                <div style="display:flex; align-items:center;">
                  <span style="margin-right:8px;">🧑🏻‍🎓</span>
                  <input type="text" name="user_organization" placeholder="Entra tu colegio" required style="flex:1; padding:10px; border-radius:10px; border:1px solid #ddd;">
                </div>
              </div>
